Algoritmo Normal
	...
	Mientras (op <> 4)
		...
		Escribir "1. ¿Deseas ver nuestros servicios?"
		Escribir "2. ¿Deseas agendar una cita?"
		Escribir "3. ¿Deseas ver nuestros productos?"
		Escribir "4. Salir."
		Leer op
		...
		Segun op Hacer
			Caso 1:
				...
				Escribir "3. LIMPIEZA."
				Escribir "¿Deseas agendar alguno de nuestros servicios?"
				Escribir "Escribe 1 para confirmar."
				Escribir "Escribe 2 para volver al menú principal."
...
SubProceso agendarCita
	...
	Escribir "Fechas disponibles en color blanco, las grises ya están reservadas."
	...
	Escribir "¿Deseas agendar una cita en las fechas disponibles? (s/n)"
	Leer confirmar
	Si confirmar = "s" Entonces
		Escribir "Ingrese los datos para agendar su cita."
		Escribir "Ingresa el día de la cita (1-31):"
		Leer dia
		...
		Leer apellido
		Escribir "Ingresa el número de contacto del paciente:"
		Leer telefono
...
SubProceso mostrarProductos
	...
	Mientras (categoria <> 0)
		...
		Escribir "0. Regresar"
		Escribir "Seleccione una opción (0 para regresar):"
		Leer categoria
		
        Si categoria >= 1 Y categoria <= 3 Entonces
            Escribir "Productos en la categoría seleccionada:"
